...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            <a href="{{url('admin/article/create')}}"><i class="fa fa-plus"></i>发表动态</a>
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            <li>
                <label>内容管理：</label><span>该管理下为新闻文章，新闻的图片和新闻的视频等内容管理</span>
            </li>
            <li>
                <label>系统管理：</label><span>系统管理管理用户账户，和项目管理，及项目的问题管理</span>
            </li>
        </ul>
    </div>
</div>
